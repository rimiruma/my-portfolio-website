...
const Navbar = ({ handleThemeToggle, isDark }) => {
    const links = <>
        ...
        {/* <NavLink className=" font-bold flex gap-1 items-center mr-4" to="https://www.linkedin.com/in/tahminatanjida/"><svg aria-label="LinkedIn logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path fill="white" d="M26.111,3H5.889c-1.595,0-2.889,1.293-2.889,2.889V26.111c0,1.595,1.293,2.889,2.889,2.889H26.111c1.595,0,2.889-1.293,2.889-2.889V5.889c0-1.595-1.293-2.889-2.889-2.889ZM10.861,25.389h-3.877V12.87h3.877v12.519Zm-1.957-14.158c-1.267,0-2.293-1.034-2.293-2.31s1.026-2.31,2.293-2.31,2.292,1.034,2.292,2.31-1.026,2.31-2.292,2.31Zm16.485,14.158h-3.858v-6.571c0-1.802-.685-2.809-2.111-2.809-1.551,0-2.362,1.048-2.362,2.809v6.571h-3.718V12.87h3.718v1.686s1.118-2.069,3.775-2.069,4.556,1.621,4.556,4.975v7.926Z" fillRule="evenodd"></path></svg>
            LinkedIn</NavLink> */}
        <NavLink className="flex gap-1 items-center font-bold" to="https://github.com/salmaakthermim">
        ...
        <div className='sticky top-0 z-50 backdrop-blur-sm bg-gradient-to-tl from-sky-300 via-blue-400 to-indigo-900 to-90% bg-opacity-20 py-4'>
            <div className="navbar bg-sky-300 rounded-lg w-11/12 mx-auto text-black">
                <div className="navbar-start">
                    ...
                    <div className='flex items-center gap-1'><img className='w-12 border border-amber-500 h-12 rounded-full object-center' src="https://logowik.com/content/uploads/images/rimi6340.logowik.com.webp" alt="Logo name!" /> <i className='font-extrabold'>Rimi Ruma</i></div>
                </div>
                ...
                <label className="flex cursor-pointer gap-2">
                    ...
                    <img className='w-12 h-12 rounded-full' src="https://avatars.githubusercontent.com/u/139052983?v=4" alt="Picture!" />
